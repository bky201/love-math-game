...
document.addEventListener("DOMContentLoaded", function() {
    ...
    for (let button of buttons) {
        let checkAnswerFunc = checkAnswer;
        let runGameFunc = runGame;
        
        button.addEventListener("click", (function(button, checkAnswerFunc, runGameFunc) {
          return function() {
            if (button.getAttribute("data-type") === "submit") {
              checkAnswerFunc();
            } else {
              let gameType = button.getAttribute("data-type");
              runGameFunc(gameType);
            }
          };
        })(button, checkAnswerFunc, runGameFunc));
      }
...
function checkAnswer() {
    ...
    if (isCorrect) {
        ...
        alert(`Ooops .... you answered ${userAnswer}. The correct answer was ${calculatedAnswer[0]}!`);
